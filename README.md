...
<p align="center">
  <a href="https://pypi.org/project/sophiagraph/"><img alt="PyPI" src="https://img.shields.io/badge/pypi-v0.0.8rc1-3775A9"></a>
...
The current SophiaGraph source is the `v0.0.8rc1` alpha release line for durable,
typed memory.
