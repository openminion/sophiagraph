...
<p align="center">
  <a href="https://pypi.org/project/sophiagraph/"><img alt="PyPI" src="https://img.shields.io/badge/pypi-v0.0.7rc1-3775A9"></a>
...
The current SophiaGraph source is the `v0.0.7rc1` alpha release candidate for
...
| --- | --- |
| Package | `sophiagraph` |
| Source line | `v0.0.7rc1` alpha release candidate |
| Python | 3.11+ |
