...
| --- | --- | --- | --- |
| Sophiagraph is a standalone wisdom graph substrate for durable agent memory. | Public stores, models, query DTOs, portability bundles, release smoke, optional in-package server runtime. | `README.md`, `tests/test_certification_suite.py`, `scripts/release_check.py` | Keep. This claim is already true. |
