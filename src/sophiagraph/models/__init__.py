...
from .self_improvement import (
    ...
    CONTRADICTION_DECISIONS as MEMORY_LIFECYCLE_CONTRADICTION_DECISIONS,
    ...
    AttributionOutcome,
    ContradictionDecision as MemoryLifecycleContradictionDecision,
...
__all__ = [
    ...
    "MEMORY_LIFECYCLE_KINDS",
    "MEMORY_LIFECYCLE_STATES",
    "MEMORY_LIFECYCLE_CONTRADICTION_DECISIONS",
    "MemoryCandidate",
    "MemoryEmbedding",
    "MemoryAttributionUpdate",
    "MemoryContradictionLink",
    "MemoryEvidenceLink",
    "MemoryLifecycleContradictionDecision",
    "MemoryLifecycleEvent",
    "MemoryLifecycleKind",
    "MemoryLifecycleState",
    "ActiveEmbeddingModelSet",
